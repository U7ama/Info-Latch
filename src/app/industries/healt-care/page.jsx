...
export default function HealthCare (){
  ...
  const subServicesTwo = [
    ...
    return(
        ...
        <div className='pt-20 min-h-fit flex justify-center items-start  text-secondary flex-col py-20 pl-20 w-[70%]'>
            <h1 className=' text-6xl  font-poppins tracking-wide font-bold leading-tight'>HealthCare development services for seamless payment integration & banking apps</h1>
  ...
  <GetandEstimateButtn/>
      ...
      {industries.map(industry => (
        ...
        <h1 className=' px-20 pt-20 text-4xl font-heading font-bold text-forth'>What we do for the Fintech domain </h1>
    ...
    <div className="py-20 px-20">
      <h1 className=" py-10 text-4xl font-heading font-semibold text-forth">Fintech challenges we solve for you </h1>
