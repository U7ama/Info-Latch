...
export default function Home() {
  ...
  data-aos-duration="900" className=' font-poppins  text-primary'>We focus on developing unique software solutions to accelerate your business's expansion.</p>
<h1  data-aos="fade-down"
  data-aos-duration="800" className='text-primary text-3xl py-4 font-overlock font-bold '>Take your ideas to the next level with Info Latch's reliable creative and technical services. We provide premium, personalized softwaresolutions to meet your specific company goals. <span className=' text-forth'>your vision's best future.</span></h1>
